...
[Collection("Database")]
public class SerializableBookingTests(DatabaseFixture fixture)
{
    [Fact]
    public async Task ConcurrentBookings_WithOneSeatAvailable_ExactlyOneSucceeds()
    {
        var eventId = await fixture.CreateEventAsync("Serializable Test Event", 1);
        var strategy = new SerializableBookingStrategy(fixture.ConnectionFactory);
